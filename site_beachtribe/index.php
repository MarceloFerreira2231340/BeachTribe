    ...
    <body>
        ...
        <section id="index_banner_section">
            <div id="index_banner_title_area">
                <img src="img/BeachTribeShadow.png"  class="index_banner_title" id="index_banner_title_shadow">
                <img src="img/BeachTribe.png" class="index_banner_title">
            </div>
            <div id="index_banner_shadow"></div>
            <h5>Por uma vida mais ativa e saudável.</h5>
            <img src="img/bannerIndex.jpg" id="index_banner_image">
        </section>
        ...
        <section id="index_section4">
            ...
            <a href="https://wordpress.g6.dwm202425.online/loja/">
